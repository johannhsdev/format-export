    ...
    <div class="container mx-auto p-4">
        ...
        <p class="mb-4 flex">
            <a href="{{ route('users.excel') }}"
                class="bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs px-4 py-2 shadow mr-4">
                Excel
            </a>

            <a href="{{ route('users.csv') }}"
                class="bg-gray-700 hover:bg-gray-600 text-white font-bold text-xs px-4 py-2 shadow">
                CSV
            </a>
